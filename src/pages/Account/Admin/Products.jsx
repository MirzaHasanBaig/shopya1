    ...
    <div className="mb-4">{
        ...
        <div className="shop-table account-orders-table mb-6">
            <div className='row'>
                ...
                <div className="card col-sm-12 col-md-4 col-lg-3" style={{padding:"10px"}} key={n}>
                    <div style={{border:"1px solid #eee"}}>
                        <img className="card-img-top" src={product.image||"Not Found"} alt={product.title||"Not Found"} style={{width:"100%"}}/>
                        <div className="card-body" style={{padding:"10px"}}>
                        <h5 className="card-title">{product.title||"Not Found"}</h5>
                        <p className="card-text">{"Colors = "+(product.colors||"Not Found")}<br/>{"Sizes = "+(product.sizes||"Not Found")}<br/>{"Price = "+product.lowPrice||"Not Found"}</p>
